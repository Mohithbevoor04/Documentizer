...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-sky-200/60 bg-white/85 backdrop-blur-xl shadow-sm">
      <div className="flex h-16 items-center justify-between px-4 md:px-8">
        
        {/* Left Branding */}
        <div className="flex items-center gap-3">
          <div className="relative flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-tr from-sky-500 via-blue-600 to-indigo-500 p-0.5 shadow-md shadow-sky-500/20">
            <div className="flex h-full w-full items-center justify-center rounded-[10px] bg-white">
              <Cpu className="h-5 w-5 text-sky-600 animate-pulse" />
            </div>
          </div>
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="rounded-full bg-sky-100 px-2 py-0.5 text-[10px] font-bold text-sky-700 border border-sky-200">
                AI v2.4
              </span>
            </div>
        ...
        <div className="relative hidden md:block">
          <button
            ...
            className="flex items-center gap-2.5 rounded-xl border border-sky-200 bg-white/90 px-3.5 py-1.5 text-xs font-semibold text-slate-700 shadow-sm transition hover:border-sky-300 hover:bg-sky-50"
          >
          ...
          {showUniMenu && (
            <div className="absolute top-full left-0 mt-2 w-72 rounded-2xl border border-sky-200 bg-white p-2.5 shadow-xl backdrop-blur-xl z-50">
              ...
              <div className="mt-1 space-y-1">
                {UNIVERSITIES.map(u => (
                  ...
                  >
                    ...
                    {u.id === selectedUniversity && <CheckCircle2 className="h-3.5 w-3.5 text-sky-600" />}
                  </button>
                ))}
              </div>
            </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="hidden lg:flex items-center gap-2 rounded-full border border-sky-200 bg-sky-50/80 px-3 py-1 text-xs font-semibold text-sky-800 shadow-sm">
            <span className="h-2 w-2 rounded-full bg-emerald-500 animate-ping" />
            <Wallet className="h-3.5 w-3.5 text-sky-600" />
            <span>Polygon PoS</span>
            <span className="text-[10px] text-sky-700 font-mono bg-sky-200/60 px-1.5 py-0.5 rounded border border-sky-300">Block #58.4M</span>
            <span className="text-[10px] opacity-75 font-mono text-slate-500">0x8f2C...9712</span>
          </div>

          {/* Notifications */}
          <button className="relative rounded-xl border border-sky-200 bg-white p-2 text-slate-600 hover:bg-sky-50 hover:text-sky-700 transition shadow-sm">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 rounded-xl border border-sky-300 bg-gradient-to-r from-sky-600 via-blue-600 to-indigo-600 px-3.5 py-1.5 text-xs font-bold text-white shadow-md hover:from-sky-500 hover:to-indigo-500 transition"
            >
            ...
            {showRoleMenu && (
              <div className="absolute right-0 top-full mt-2 w-72 rounded-2xl border border-sky-200 bg-white p-2.5 shadow-2xl backdrop-blur-2xl z-50">
                <div className="flex items-center justify-between px-3 py-1.5 border-b border-sky-100 mb-2">
